...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Najmul Data").child(key);
    ...
    public void saveData(){
        storageReference = FirebaseStorage.getInstance().getReference().child("Najmul Images").child(uri.getLastPathSegment());
...
//                    StorageReference reference = FirebaseStorage.getInstance().getReferenceFromUrl(oldImageUrl);
//                    reference.delete();
//                    Toast.makeText(UpdateActivity.this, "Updatd", Toast.LENGTH_SHORT).show();
//                    finish();
//                }
//            }
//        }).addOnFailureListener(new OnFailureListener() {
